...
/*
** Check is this string contain prefix of its numberal system
*/
...
/*
** Check is this char present in selected numberal system
*/
...
/*
** Convert string to number according to the selected number system
*/
